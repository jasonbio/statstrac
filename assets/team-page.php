...
<head>
	<meta charset="utf-8" />
	<title><?php if ($view === "standings") { echo "Standings"; } else { echo $city." ".$teamname["".$team.""]." ".$year; } ?> | statstrac - NFL statistics platform</title>
    ...
    <link href="assets/css/custom/team.css" rel="stylesheet" />
...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<div class="row">
				<div class="col-md-6">
			        <div class="panel-group" id="AFCE">
						<?php echo $AFCEw; ?>
					</div>
				</div>
				<div class="col-md-6">
					<div class="panel-group" id="AFCS">
						<?php echo $AFCSw; ?>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6">
					<div class="panel-group" id="AFCN">
						<?php echo $AFCNw; ?>
					</div>
				</div>
				<div class="col-md-6">
					<div class="panel-group" id="AFCW">
						<?php echo $AFCWw; ?>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6">
			        <div class="panel-group" id="NFCE">
						<?php echo $NFCEw; ?>
					</div>
				</div>
				<div class="col-md-6">
					<div class="panel-group" id="NFCS">
						<?php echo $NFCSw; ?>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6">
					<div class="panel-group" id="NFCN">
						<?php echo $NFCNw; ?>
					</div>
				</div>
				<div class="col-md-6">
					<div class="panel-group" id="NFCW">
						<?php echo $NFCWw; ?>
					</div>
				</div>
			</div>
			...
			<?php else: ?>
				...
				<?php foreach ($widget as $teamwidget) { echo $teamwidget; } ?>
