...
<head>
	<meta charset="utf-8" />
	<title>statstrac - open NFL statistics platform</title>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse pull-left" id="top-navbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                Sort Games <b class="caret"></b>
                            </a>
                            <ul class="dropdown-menu" role="menu">
                                <?php echo $sortdropdown; ?>
                            </ul>
                        </li>
                    </ul>
                </div>
				...
				<ul class="nav">
					<li class="has-sub">
						...
						<ul class="sub-menu">
							...
							<?php if ($lastweek) : ?>
								<li><a href="<?php echo $lastweek; ?>">Previous Week</a></li>
							<?php endif; ?>
							<?php if ($lyear) : ?>
								<li><a href="<?php echo $lyear; ?>">Previous Season</a></li>
							<?php endif; ?>
						</ul>
					</li>
					<li class="has-sub">
					...
					<li class="has-sub active">
						<a href="javascript:;">
						    ...
						    <span><?php echo $year; ?> Standings</span>
					    </a>
					    <ul class="sub-menu">
							<li class="has-sub active">
								<a href="javascript:;">
