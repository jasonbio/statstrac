...
<head>
	<meta charset="utf-8" />
	<title><?php echo $awaycode.' vs. '.$homecode.' - '.$date_f.' '.$yearofgame; ?> | statstrac - open NFL statistics platform</title>
	<meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" name="viewport" />
	<meta content="" name="description" />
	<meta content="" name="author" />
	<?php echo $progress_updater; ?>
    ...
    <link href="assets/css/custom/game.css" rel="stylesheet" />
...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed gradient-enabled">
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse pull-left" id="top-navbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <?php echo $awaycode.' vs. '.$homecode; ?> <b class="caret"></b>
                            </a>
                            <ul class="dropdown-menu" role="menu">
                                <?php foreach ($totalgames as $val) { echo $val; } ?>
                            </ul>
                        </li>
                    </ul>
                </div>
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					<li class="has-sub active">
						...
						<ul class="sub-menu">
							<li class="active"><a href="/">Current Week</a></li>
							<?php if ($lastweek) : ?>
				...
				<ul class="nav">
					<li class="nav-header"><?php echo $awaycode.' vs. '.$homecode; ?> Leaders</li>
					<li class="nav-profile">
						<?php foreach ($weeklyleaders as $weeklyleader) { echo $weeklyleader; } ?>
					</li>
				</ul>
				<!-- end sidebar nav -->
			</div>
		...
		<div id="content" class="content">
			<!-- begin row -->
			    <!-- begin score widgets -->
			    <?php foreach ($widget as $gamewidget) { echo $gamewidget; } ?>
			    <!-- end score widgets -->
			</div>
			<!-- end row -->
		</div>
    ...
    <script src="assets/plugins/jquery.countdown-2.1.0/jquery.countdown.min.js"></script>
