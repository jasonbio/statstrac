...
<head>
	<meta charset="utf-8" />
	<title><?php echo $year.' '.$graph_stat_title; ?> | statstrac - open NFL statistics platform</title>
    ...
    <link href="assets/css/custom/stats.css" rel="stylesheet" />
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu">
							<?php if ($view === "passing") : ?>
								<li class="active"><a href="stats.php?view=passing">Passing Yards</a></li>
							<?php else: ?>
								<li><a href="stats.php?view=passing">Passing Yards</a></li>
							<?php endif; ?>
							<?php if ($view === "rushing") : ?>
								<li class="active"><a href="stats.php?view=rushing">Rushing Yards</a></li>
							<?php else: ?>
								<li><a href="stats.php?view=rushing">Rushing Yards</a></li>
							<?php endif; ?>
							<?php if ($view === "receiving") : ?>
								<li class="active"><a href="stats.php?view=receiving">Receiving Yards</a></li>
							<?php else: ?>
